...
class ToneCurveLeftView: UIView
{
    override func drawRect(rect: CGRect) {
        ...
        let gradientRef = CGGradientCreateWithColorComponents(colorSpaceRef
...
class ToneCurveView: UIView
{
    ...
    func setKeyPoints(arr: NSMutableArray) {
        points = arr;
    }
    ...
    , ToneCurvePointUpdateDelegate
{
    ...
    func toneCurveViewUpdate() {
        ...
        {
        case rgbselect.red:
            toneCurveView.setKeyPoints(points_r);
            break;
        case rgbselect.green:
            toneCurveView.setKeyPoints(points_g);
            break;
        case rgbselect.blue:
            toneCurveView.setKeyPoints(points_b);
            break;
        default:
            toneCurveView.setKeyPoints(points);
            break;
        }
        toneCurveView.draw();
    }
